"""
Module for camera-related functionality in the Engine.
"""
...
class Camera:
    ...
    def __init__(
        ...
        Args:
            ...
            background: Background color symbol (default: ``"B"`` - black)
            letter_box: Letter box color symbol (default: ``"B"`` - black)
